...
public interface InvoiceRepo extends JpaRepository<Invoice, Long> {
    ...
    Page<Invoice> findByCustomerIdContainingIgnoreCaseOrCustomerPersonalDetailsEmailIdContainingIgnoreCase(String searchTerm, String searchTerm1, Pageable pageable);
}
